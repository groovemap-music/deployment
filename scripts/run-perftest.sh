...
[[ "$image" =~ ^ghcr\.io/groovemap-music/catalog-api-performance@sha256:[0-9a-f]{64}$ ]] || {
  echo "PERFTEST_IMAGE must use ghcr.io/groovemap-music/catalog-api-performance@sha256:<64 hex>." >&2
  exit 2
}
